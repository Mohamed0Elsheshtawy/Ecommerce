<template>
    <div class="features bg-grey-lighten-4  py-15">

        <v-container fluid>
            <v-row>
                <v-col v-for="card in cards" :key="card.title" >
                    <v-hover v-slot="{ isHovering, props }">
                    <v-card class="text-center cursor-pointer" height="350px" 
                    v-bind:="props" 
                    :elevation="isHovering ? 10 : 0"
                    :color="isHovering ?'amber-accent-2':'white'"
                    
                    >
                        <span class="py-10 d-flex align-center justify-center" v-html="card.svg">
                        </span>
            ...
            cards:[
                {
                    ...
                    desc:" Lorem ipsum, dolor sit amet consectetur adipisicing elitOptio dolores corrupti nam illum sit in eaque debitis mollitiarepellat quis, iste ut cum, possimus veniam nostrum odio commodi! Consectetur,amet!",
